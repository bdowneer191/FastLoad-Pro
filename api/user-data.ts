    ...
    try {
        if (request.method === 'GET') {
            try {
                ...
                return new Response(JSON.stringify(blobContent), { 
                    status: 200, 
                    headers: { 'Content-Type': 'application/json' } 
                });
            } catch (e) {
            ...
            try {
                ...
                if (typeof geminiApiKey === 'undefined' || typeof pageSpeedApiKey === 'undefined') {
                     return new Response(JSON.stringify({ 
                         message: 'Both geminiApiKey and pageSpeedApiKey must be provided.' 
                     }), { 
                         status: 400, 
                         headers: { 'Content-Type': 'application/json' } 
                     });
                ...
                return new Response(JSON.stringify({ success: true, message: 'API keys saved.' }), { 
                    status: 200, 
                    headers: { 'Content-Type': 'application/json' } 
                });
            } catch (e: any) {
        ...
        if (request.method === 'DELETE') {
            try {
                ...
                return new Response(JSON.stringify({ success: true, message: 'API keys deleted.' }), { 
                    status: 200, 
                    headers: { 'Content-Type': 'application/json' } 
                });
            } catch (e: any) {
